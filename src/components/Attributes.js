...
export const AttributeDisplay = (props) => {
    ...
    if(props.typeof == "Volatility"){
        return(
            <CircularProgressbar value={storeobj("Jordan 1 Retro High Bred Toe", attributes)[props.typeof] * 100} text={Math.round(storeobj("Jordan 1 Retro High Bred Toe", attributes)[props.typeof] * 100) +"%"}></CircularProgressbar>
        )
    }
